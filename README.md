...
- **R** for data extraction via fingertipsR, cleaning, analysis, ggplot2 visualisation, and the R Markdown report
- **PostgreSQL** as the relational database storing and joining all data sources
...
Three districts were excluded: City of London and the Isles of Scilly due to anomalous population sizes, and Buckinghamshire UA due to a boundary mismatch with the study period. See `docs/METHODS.md` for detail.
